...
import { ThumbBar, ZhimaContractDialog } from "../../components";
...
const OrderPage = () => {
  ...
  const [showZhima, setShowZhima] = useState<boolean>(false);
  ...
  return (
    <div className="container">
      ...
      <ZhimaContractDialog
        ...
        onAgree={() => {
          setShowZhima(false);
          message.success("合同已确认，先学后付扣款将在支付宝芝麻信用联调后开通");
        }}
      />
    </div>
  );
