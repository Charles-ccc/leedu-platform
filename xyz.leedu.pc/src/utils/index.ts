...
export function getToken(): string {
  return window.localStorage.getItem("leedu-user-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("leedu-user-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("leedu-user-token");
}

export function getPlayId(): string {
  return window.localStorage.getItem("leedu-play-id") || "";
}

export function savePlayId(id: string) {
  window.localStorage.setItem("leedu-play-id", id);
}

export function clearPlayId() {
  window.localStorage.removeItem("leedu-play-id");
}
...
export function getBindMobileKey(): string {
  return window.localStorage.getItem("leedu-bind-mobile") || "";
}

export function setBindMobileKey() {
  window.localStorage.setItem("leedu-bind-mobile", "ok");
}

export function clearBindMobileKey() {
  window.localStorage.removeItem("leedu-bind-mobile");
}

export function getFaceCheckKey(): string {
  return window.localStorage.getItem("leedu-face-check") || "";
}

export function setFaceCheckKey() {
  window.localStorage.setItem("leedu-face-check", "ok");
}

export function clearFaceCheckKey() {
  window.localStorage.removeItem("leedu-face-check");
}
