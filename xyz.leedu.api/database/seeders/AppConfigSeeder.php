    ...
    public function run()
    {
        $config = [
            ...
            [
                ...
                'sort' => 200,
                'default_value' => '',
                'key' => 'leedu.course_purchase_notice',
                'value' => '',
            ],
            ...
            [
                ...
                'field_type' => 'select',
                'sort' => -1,
                'key' => 'leedu.system.login.limit.rule',
            ...
            [
                ...
                'sort' => 4,
                'default_value' => 0,
                'key' => 'leedu.member.socialite.qq.enabled',
                'value' => 0,
            ],
            [
                'group' => '登录',
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 10,
                'key' => 'leedu.payment.alipay.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 100,
                'key' => 'leedu.payment.wechat.enabled',
                'value' => 0,
                'help' => 'PC端口使用',
            ],
            [
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 300,
                'key' => 'leedu.payment.handPay.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
                ...
                'field_type' => 'longtext',
                'sort' => 310,
                'key' => 'leedu.payment.handPay.introduction',
                'value' => '',
            ],
            ...
            [
                ...
                'field_type' => 'select',
                'sort' => 1,
                'key' => 'leedu.upload.video.default_service',
                'option_value' => json_encode([
                    [
                        'title' => '阿里云',
                        'key' => 'aliyun',
            ...
            [
                ...
                'sort' => 0,
                'default_value' => 0,
                'key' => 'leedu.member.enabled_mobile_bind_alert',
                'value' => 0,
            ],
            [
                'group' => '会员',
                ...
                'sort' => 0,
                'default_value' => 0,
                'key' => 'leedu.member.enabled_face_verify',
                'value' => 0,
            ],
            [
                'group' => '会员',
                ...
                'sort' => 2,
                'default_value' => 0,
                'key' => 'leedu.member.is_lock_default',
                'value' => 0,
            ],
            [
                'group' => '会员',
                ...
                'field_type' => 'image',
                'sort' => 3,
                'key' => 'leedu.member.default_avatar',
            ...
            [
                ...
                'sort' => 0,
                'default_value' => 0,
                'key' => 'leedu.member.credit1.register',
                'value' => 0,
            ],
            [
                'group' => '积分',
                ...
                'sort' => 2,
                'default_value' => 0,
                'key' => 'leedu.member.credit1.watched_course',
                'value' => 0,
            ],
            [
                'group' => '积分',
                ...
                'sort' => 3,
                'default_value' => 0,
                'key' => 'leedu.member.credit1.watched_video',
                'value' => 0,
            ],
            [
                'group' => '积分',
                ...
                'sort' => 4,
                'default_value' => 0,
                'key' => 'leedu.member.credit1.paid_order',
                'value' => 0,
            ...
            [
                ...
                'sort' => 1,
                'default_value' => 0,
                'key' => 'leedu.system.player.enabled_bullet_secret',
                'value' => 0,
            ],
            [
                'group' => '播放器配置',
                ...
                'field_type' => 'text',
                'sort' => 10,
                'key' => 'leedu.system.player.bullet_secret.text',
                'value' => '',
            ...
            [
                ...
                'field_type' => 'number',
                'sort' => 20,
                'key' => 'leedu.system.player.bullet_secret.size',
                'value' => 14,
            ],
            [
                'group' => '播放器配置',
                ...
                'field_type' => 'text',
                'sort' => 30,
                'key' => 'leedu.system.player.bullet_secret.color',
                'value' => '',
            ],
            [
                'group' => '播放器配置',
                ...
                'field_type' => 'text',
                'sort' => 40,
                'key' => 'leedu.system.player.bullet_secret.opacity',
                'value' => 1,
            ],
            ...
            [
                ...
                'field_type' => 'text',
                'sort' => 1,
                'key' => 'leedu.mp_wechat.app_secret',
                'value' => '',
                'is_private' => 1,
            ],
            [
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 6,
                'key' => 'leedu.mp_wechat.enabled_oauth_login',
                'value' => 0,
            ],
            [
                'group' => '微信公众号',
                ...
                'field_type' => 'switch',
                'sort' => 8,
                'key' => 'leedu.mp_wechat.share.enabled',
                'value' => 0,
            ],
            [
                'group' => '微信公众号',
                ...
                'field_type' => 'text',
                'sort' => 10,
                'key' => 'leedu.mp_wechat.share.title',
                'value' => '',
            ],
            [
                'group' => '微信公众号',
                ...
                'field_type' => 'text',
                'sort' => 11,
                'key' => 'leedu.mp_wechat.share.desc',
                'value' => '',
            ],
            [
                'group' => '微信公众号',
                ...
                'field_type' => 'image',
                'sort' => 12,
                'key' => 'leedu.mp_wechat.share.imgUrl',
                'value' => '',
            ],
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 0,
                'key' => 'leedu.member.register.vip.enabled',
                'value' => 0
            ],
            [
                'group' => '注册送VIP',
                ...
                'field_type' => 'number',
                'sort' => 1,
                'key' => 'leedu.member.register.vip.role_id',
                'value' => 0
            ],
            [
                'group' => '注册送VIP',
                ...
                'field_type' => 'number',
                'sort' => 2,
                'key' => 'leedu.member.register.vip.days',
                'value' => 0,
            ],
