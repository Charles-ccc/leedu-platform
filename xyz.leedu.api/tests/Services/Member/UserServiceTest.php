...
class UserServiceTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        config([
            'leedu.member.default_avatar' => 'default-avatar.png',
            'leedu.member.is_lock_default' => 1,
            'leedu.member.is_active_default' => 1,
        ]);
    }
    ...
    {
        config([
            'leedu.member.default_avatar' => 'default-avatar.jpg',
            'leedu.member.is_lock_default' => 2,
            'leedu.member.is_active_default' => 3,
        ]);
    ...
    {
        config([
            'leedu.member.default_avatar' => 'from-config.png',
        ]);
        Event::fake([UserRegisterEvent::class]);
