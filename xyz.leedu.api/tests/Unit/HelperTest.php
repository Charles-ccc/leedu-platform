...
class HelperTest extends TestCase
{
    ...
    public function test_get_array_ids()
    {
        ...
        $this->assertEquals(['leedu', 'leedu2'], get_array_ids($arr, 'name'));
    }
    ...
    {
        $url = 'https://leedu.vip';
        $url1 = 'https://leedu.vip?name=leedu';
        $data = [
            'params1' => 1,
            'params2' => 2,
        ];

        $this->assertEquals('https://leedu.vip?params1=1&params2=2', url_append_query($url, $data));
        $this->assertEquals('https://leedu.vip?name=leedu&params1=1&params2=2', url_append_query($url1, $data));
    }
