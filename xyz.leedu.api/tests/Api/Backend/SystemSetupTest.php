...
class SystemSetupTest extends Base
{
    protected function setUp(): void
    {
        ...
        AdministratorRole::query()->firstOrCreate(
            ['slug' => config('leedu.administrator.super_slug')],
    ...
    public function test_valid_request_creates_super_admin()
    {
        ...
        $superSlug = config('leedu.administrator.super_slug');
    ...
    {
        AdministratorRole::query()->where('slug', config('leedu.administrator.super_slug'))->delete();
