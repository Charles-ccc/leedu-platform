...
class MemberTest extends Base
{
    ...
    {
        $this->member->notify(new SimpleMessageNotification('leedu消息测试'));
    ...
    {
        $this->member->notify(new SimpleMessageNotification('leedu消息测试1'));
        $this->member->notify(new SimpleMessageNotification('leedu消息测试2'));
        $this->member->notify(new SimpleMessageNotification('leedu消息测试3'));
