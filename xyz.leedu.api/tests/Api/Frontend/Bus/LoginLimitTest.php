...
class LoginLimitTest extends OriginalTestCase
{
    ...
    {
        // 将登录限制改为[不限制]
        config(['leedu.system.login.limit.rule' => FrontendConstant::LOGIN_LIMIT_RULE_DEFAULT]);
    ...
    {
        // 将登录限制改为[仅允许一台设备登录]
        config(['leedu.system.login.limit.rule' => FrontendConstant::LOGIN_LIMIT_RULE_ALL]);
