...
if (!function_exists('get_platform')) {
    ...
    function get_platform()
    {
        ...
        $platform = strtoupper(request()->header('leedu-platform', \App\Constant\FrontendConstant::LOGIN_PLATFORM_APP));
        $platforms = [
...
if (!function_exists('save_image')) {
    function save_image($file, $scene = ''): array
    {
        ...
        /**
         * @var \App\Leedu\ServiceV2\Services\OtherServiceInterface $otherService
         */
        $otherService = app()->make(\App\Leedu\ServiceV2\Services\OtherServiceInterface::class);
