...
class MemberController extends BaseController
{
    ...
    public function import(Request $request)
    {
        ...
        DB::transaction(function () use ($transformedUserList) {
            $now = Carbon::now()->toDateTimeLocalString();
            $defaultAvatar = url(config('leedu.member.default_avatar'));
            $defaultActiveStatus = (int)config('leedu.member.is_active_default');
            $defaultIsLockStatus = (int)config('leedu.member.is_lock_default');
