...
class OtherController extends BaseController
{
    ...
    public function config(Addons $addons, ConfigServiceInterface $configService, LinkCache $linkCache, NavCache $navCache)
    {
        ...
        /**
         * @var \App\Leedu\ServiceV2\Services\ConfigServiceInterface $configServiceV2
         */
        $configServiceV2 = app()->make(\App\Leedu\ServiceV2\Services\ConfigServiceInterface::class);
