...
class UpgradeV480
{
    ...
    public static function deleteConfig()
    {
        AppConfig::query()
            ->whereIn('key', [
                'leedu.member.invite.free_user_enabled',
                'leedu.member.invite.invite_user_reward',
                'leedu.member.invite.invited_user_reward',
                'leedu.member.invite.effective_days',
                'leedu.member.invite.per_order_draw',
                'leedu.member.credit1.invite',//邀请送积分
