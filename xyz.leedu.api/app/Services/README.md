...
Leedu 在设计之初，代码层面的架构其实也脱离不了 MVC 的范畴，你可以处处看到它的影子。作者在持续维护 Leedu 的过程中，随着技术提升和视野的转变，对于系统
有了更深入的了解，于是决定对 Leedu 进行一次变化较为彻底的重新架构设计：服务化设计！引入该设计的目的是使 Leedu 的代码耦合度更低，更易于维护，单元测试
覆盖率更高！
...
+ 微服务架构设计，服务替换无感知
+ 达到更高的单元测试覆盖率
+ 让支持 Leedu 的小伙伴花费最少的时间参与 Leedu 的开发
...
| `Member` | 会员服务，负责 Leedu 系统的会员注册/登录/找回密码/会员等级等 |
