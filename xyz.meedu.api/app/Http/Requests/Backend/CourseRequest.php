...
class CourseRequest extends BaseRequest
{
    ...
    public function filldata()
    {
        return [
            ...
            // 平台化:芝麻先享分期配置
            'installment_enabled' => (int)$this->input('installment_enabled', 0),
            'installment_periods' => max(1, (int)$this->input('installment_periods', 1)),
            'installment_cycle_days' => max(1, (int)$this->input('installment_cycle_days', 30)),
        ];
    }
}
