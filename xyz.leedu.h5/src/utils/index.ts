...
export function getToken(): string {
  return window.localStorage.getItem("leedu-h5-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("leedu-h5-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("leedu-h5-token");
}

export function getTmpToken(): string {
  return window.localStorage.getItem("leedu-h5-tmp-token") || "";
}

export function saveTmpToken(token: string) {
  window.localStorage.setItem("leedu-h5-tmp-token", token);
}

export function clearTmpToken() {
  window.localStorage.removeItem("leedu-h5-tmp-token");
}

export function getMsv(): string {
  return window.localStorage.getItem("leedu-msv") || "";
}

export function saveMsv(msv: string) {
  window.localStorage.setItem("leedu-msv", msv);
}

export function clearMsv() {
  window.localStorage.removeItem("leedu-msv");
}

export function getBizToken() {
  return window.localStorage.getItem("leedu-user-face-bizToken");
}

export function saveBizToken(token: string) {
  window.localStorage.setItem("leedu-user-face-bizToken", token);
}

export function clearBizToken() {
  window.localStorage.removeItem("leedu-user-face-bizToken");
}

export function getRuleId() {
  return window.localStorage.getItem("leedu-user-face-ruleId");
}

export function saveRuleId(token: string) {
  window.localStorage.setItem("leedu-user-face-ruleId", token);
}

export function clearRuleId() {
  window.localStorage.removeItem("leedu-user-face-ruleId");
}
