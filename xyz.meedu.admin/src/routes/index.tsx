...
//平台化:机构管理
const MerchantPage = lazy(() => import("../pages/merchant/index"));
//平台化:课程审核
const CourseAuditPage = lazy(() => import("../pages/merchant/course-audit"));
//平台化:机构入驻申请(公开)
const MerchantApplyPage = lazy(() => import("../pages/merchant/apply"));
//平台化:机构支付宝配置
const MerchantAlipayConfigPage = lazy(
  () => import("../pages/merchant/alipay-config")
);
//平台化:平台分账
const ProfitSharePage = lazy(() => import("../pages/merchant/profit-share"));
//平台化:业务员 + 提成
const SalespersonPage = lazy(() => import("../pages/merchant/salesperson"));
const CommissionPage = lazy(() => import("../pages/merchant/commission"));
const WithdrawalPage = lazy(() => import("../pages/merchant/withdrawal"));
const MyCommissionPage = lazy(() => import("../pages/merchant/my-commission"));
//平台化:合同模板(芝麻先享)
const AgreementTemplatePage = lazy(
  () => import("../pages/merchant/agreement-template")
);
...
if (getToken() && window.location.pathname !== "/error") {
  ...
  if (
    ...
    window.location.pathname !== "/merchant/apply" &&
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/merchant/index", element: <MerchantPage /> },
          { path: "/merchant/course-audit", element: <CourseAuditPage /> },
          {
            path: "/merchant/alipay-config",
            element: <MerchantAlipayConfigPage />,
          },
          { path: "/merchant/profit-share", element: <ProfitSharePage /> },
          { path: "/merchant/salesperson", element: <SalespersonPage /> },
          { path: "/merchant/commission", element: <CommissionPage /> },
          { path: "/merchant/withdrawal", element: <WithdrawalPage /> },
          { path: "/merchant/my-commission", element: <MyCommissionPage /> },
          { path: "/merchant/agreement-template", element: <AgreementTemplatePage /> },
