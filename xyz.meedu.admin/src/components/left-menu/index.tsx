...
const items = [
  ...
  getItem(
    ...
    [
      getItem("机构管理", "/merchant/index", null, null, null, "super-slug"),
      getItem("课程审核", "/merchant/course-audit", null, null, null, "super-slug"),
      getItem("平台分账", "/merchant/profit-share", null, null, null, "super-slug"),
      getItem("业务员管理", "/merchant/salesperson", null, null, null, "super-slug"),
      getItem("提成记录", "/merchant/commission", null, null, null, "super-slug"),
      getItem("业务员提现", "/merchant/withdrawal", null, null, null, "super-slug"),
      getItem("合同模板", "/merchant/agreement-template", null, null, null, "super-slug"),
      getItem("业务员提成", "/merchant/my-commission", null, null, null, "merchant-self"),
      getItem("支付宝配置", "/merchant/alipay-config", null, null, null, "merchant-self"),
    ],
    null,
    null
  ),
  ...
  const checkMenuPermissions = (items: any, user: any) => {
    ...
    for (let i in items) {
      ...
      for (let j in menuItem.children) {
        ...
        if (childrenItem.permission === "merchant-self") {
          // 仅机构管理员(merchant_id>0)可见
          if (user.merchant_id && user.merchant_id > 0) {
            children.push(childrenItem);
          }
          continue;
        }
