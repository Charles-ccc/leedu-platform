...
const CourseUpdatePage = () => {
  ...
  const getDetail = async () => {
    ...
    form.setFieldsValue({
      ...
      installment_cycle_days: data.installment_cycle_days,
    });
    ...
    <div className="leedu-main-body">
      ...
      >
        ...
        >
          ...
          <Form.Item label="分期期数" name="installment_periods">
            <Input style={{ width: 300 }} type="number" placeholder="如 3 期" />
          </Form.Item>
          <Form.Item label="每期周期(天)" name="installment_cycle_days">
            <Input style={{ width: 300 }} type="number" placeholder="如 30 天" />
          </Form.Item>
