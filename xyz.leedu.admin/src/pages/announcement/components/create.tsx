...
export const NoticeCreate: React.FC<PropInterface> = ({ open, onClose }) => {
  ...
  return (
    <>
      {open && (
        <div className="leedu-dialog-mask">
          <div className="leedu-dialog-box">
            <div className="leedu-dialog-header">添加公告</div>
            <div className="leedu-dialog-body">
              <Form
                form={form}
                name="notice-create"
                labelCol={{ span: 3 }}
            ...
            <div className="leedu-dialog-footer">
              <Button
                loading={loading}
                type="primary"
                onClick={() => form.submit()}
