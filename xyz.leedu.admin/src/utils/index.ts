...
export function getToken(): string {
  return window.localStorage.getItem("leedu-admin-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("leedu-admin-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("leedu-admin-token");
}

export function getPreToken(): string {
  return window.localStorage.getItem("leedu-admin-pre-token") || "";
}

export function setPreToken(token: string) {
  window.localStorage.setItem("leedu-admin-pre-token", token);
}

export function clearPreToken() {
  window.localStorage.removeItem("leedu-admin-pre-token");
}
...
export function saveEditorKey(key: string) {
  window.localStorage.setItem("leedu-editor-key", key);
}

export function getEditorKey() {
  return window.localStorage.getItem("leedu-editor-key");
}
